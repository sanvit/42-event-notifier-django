...
SECRET_KEY = os.environ.get(
    'SECRET_KEY', '?tXT4bPfMDd?GKQS9y3hs?hCRtf8df!exgNhP!cPEhaQjJDc&#JCn8E7iPsK4#XgbsN?b&eMBoHcSN?h')
...
DEFAULT_FROM_EMAIL = os.environ.get(
    'EMAIL_FROM_ADDR', '42 Events Alert <ft_events@jaewon.dev>')
...
SECURE_HSTS_SECONDS = None if DEBUG else 60 * 60 * 24 * 365
